...
const testimonials = [
  {
    quote:
      "Najib is one of the most talented IT students I've teach with. His dedication and ability to solve complex problems is impressive.",
...
export const Testimonials = () => {
  ...
  mx-auto mb-16"
    ...
    animation-delay-100 text-foreground"
          >
            Kind words from{" "}
            <span
